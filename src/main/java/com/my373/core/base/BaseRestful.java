 ...
 * 
 */
public interface BaseRestful<T, ID> {
	 ...
	 * /book
	 */
	public String create(T entity, Model model, HttpServletRequest request, HttpServletResponse response);
	 ...
	 * /book/2
	 */
	public String update(ID id, T entity, Model model, HttpServletRequest request, HttpServletResponse response);
